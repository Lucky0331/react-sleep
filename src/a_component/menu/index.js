        ...
        return (
            this.state.show ?
                [<Menu
                    ...
                    defaultOpenKeys={['sub0','sub1','sub2','sub3','sub4','sub5','sub6','sub7']}
                    onSelect={(e) => this.onMenuSelect(e)}
                >
                    <SubMenu className={type === 'sub0' ? '' : 'hide'} key="sub0" title={<span>系统管理</span>}>
                    ...
                    <SubMenu className={type === 'sub1' ? '' : 'hide'} key="sub1" title={<span>产品管理</span>}>
                    ...
                    <SubMenu className={type === 'sub2' ? '' : 'hide'} key="sub2" title={<span>订单管理</span>}>
                            <Menu.Item key="/order/orderlist"><Link to="/order/orderlist">订单列表</Link></Menu.Item>
                            <Menu.Item key="/order/ordertwo"><Link to="/order/ordertwo">订单列表查询</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu className={type === 'sub3' ? '' : 'hide'} key="sub3" title={<span>服务站管理</span>}>
                        <Menu.Item key="/service/station"><Link to="/service/station">产品上线</Link></Menu.Item>
                        <Menu.Item key="/service/contracts"><Link to="/service/contracts">承包上线</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu className={type === 'sub4' ? '' : 'hide'} key="sub4" title={<span>体检管理</span>}>
                        ...
                        <Menu.Item key="/physical/station"><Link to="/physical/station">服务站统计</Link></Menu.Item>
                    ...
                    <SubMenu className={type === 'sub5' ? '' : 'hide'} key="sub5" title={<span>资金管理</span>}>
                        ...
                        <SubMenu key="sub5-2" title="资金流向">
                            <Menu.Item key="/money/flow"><Link to="/money/flow">经营收益</Link></Menu.Item>
                            <Menu.Item key="/money/serviceIn"><Link to="/money/serviceIn">服务收益</Link></Menu.Item>
                        </SubMenu>
                        <SubMenu key="sub5-3" title="收益查询">
                            <Menu.Item key="/money/flow2"><Link to="/money/flow2">经营收益</Link></Menu.Item>
                            <Menu.Item key="/money/serviceIn2"><Link to="/money/serviceIn2">服务收益</Link></Menu.Item>
                        </SubMenu>
                        <Menu.Item key="/money/query"><Link to="/money/query">结算查询</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu className={type === 'sub6' ? '' : 'hide'} key="sub6" title={<span>发票管理</span>}>
                        <Menu.Item key="/invoice/pending"><Link to="/invoice/pending">待处理申请</Link></Menu.Item>
                        <Menu.Item key="/invoice/applylist"><Link to="/invoice/applylist">申请记录</Link></Menu.Item>
                    </SubMenu>
                    <SubMenu className={type === 'sub7' ? '' : 'hide'} key="sub7" title={<span>内容管理</span>}>
                        <Menu.Item key="/content/banner"><Link to="/content/banner">banner管理</Link></Menu.Item>
                    </SubMenu>
                </Menu>] : null
        );
    }
