...
// import lazePage1 from 'bundle-loader?lazy!./container/page1';
// import lazePage2 from 'bundle-loader?lazy!./container/page2';
// import lazePage3 from 'bundle-loader?lazy!./container/page3';
//
// const Page1 = (props) => (
//   <Bundle load={lazePage1}>
//     {(Page1) => <Page1 {...props} />}
//   </Bundle>
// );
// const Page2 = (props) => (
//   <Bundle load={lazePage2}>
//     {(Page2) => <Page2 {...props} />}
//   </Bundle>
// );
// const Page3 = (props) => (
//   <Bundle load={lazePage3}>
//     {(Page3) => <Page3 {...props} />}
//   </Bundle>
// );
...
class TestPageContainer extends React.Component {
    ...
    render() {
        return ([
            ...
            <div key="page" className="page-test">
