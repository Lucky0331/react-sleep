...
import { Form, Button, Icon, Table, message, DatePicker, Radio, Tooltip, Select, Divider } from 'antd';
import './index.scss';
    ...
    makeOption(data = null) {
        ...
        const option = {
            ...
            yAxis : [
                {
                    type: 'category',
                    data : ['其他','合肥体验服务中心','合肥体验服务中心','合肥体验服务中心','合肥体验服务中心','合肥体验服务中心','合肥体验服务中心','合肥体验服务中心'],
                },
            ],
            series : [
                {
            ...
            <div style={{ width: '100%' }}>
              <div className="system-search">
                ...
                <div className="charts-box">
                    <div id="echarts-3" className="echarts" style={{width:'46%',float:'left',height:'320px'}}/>
                    <div id="echarts-4" className="echarts" style={{width:'46%',float:'right',height:'290px'}}/>
                </div>
                <div className="charts-box">
                    <div id="echarts-1" className="echarts" style={{width:'46%',float:'left',height:'290px'}}/>
                    <div id="echarts-2" className="echarts" style={{width:'46%',float:'right',height:'290px'}}/>
                </div>
