...
class Category extends React.Component {
  ...
  onAddNewShow() {
    const me = this;
    const { form } = me.props;
    //为了清空modal中的值，所以用到了resetFields方法，
    //该方法主要是对form中的值进行重置，没有默认值的情况下会被清空
    form.resetFields([
      "addnewNum",
      "addnewBeginTime",
      "addnewEndTime"
              ...
              <RadioGroup onChange={(e) => this.onRadioLimitChange(e)} value={this.state.radioLimit}>
                ...
                <Radio value={2}>
                  ...
                  {getFieldDecorator("addnewPerson", {
                    initialValue: undefined,
                  })(<Input placeholder="请输入次数" style={{ width: "110px" ,marginRight:'5px',marginLeft:'5px'}} disabled={this.state.radioLimit !== 2}/>)}次/人
                </Radio>
              </RadioGroup>
            </FormItem>
          </Form>
