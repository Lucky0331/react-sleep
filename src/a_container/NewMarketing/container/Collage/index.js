                ...
                <FormItem label="10.添加活动商品图文">
                  <FormItem label="①" {...formItemLayout} labelCol={{ span: 1 }}>
                    {getFieldDecorator("formTitle", {
                      ...
                      <Input style={{width:'200px',marginLeft:'-25px'}} placeholder="输入活动标题"/>
                    )}
                  </FormItem>
