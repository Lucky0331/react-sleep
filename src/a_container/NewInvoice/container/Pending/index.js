...
import { findOrderByWhere, findProductTypeByWhere, updateProductType,onChange,onOk} from '../../../../a_action/shop-action';
...
export default connect(
    ...
    (dispatch) => ({
        actions: bindActionCreators({ findOrderByWhere,findProductTypeByWhere, updateProductType,onChange,onOk }, dispatch),
    })
