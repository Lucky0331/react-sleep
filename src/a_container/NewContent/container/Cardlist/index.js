    ...
    makeColumns(){
        const columns = [
            ...
            },
            {
                ...
                key: 'deleteStatus',
                render: (text) => Boolean(text) === true ? <span style={{color: 'green'}}>已发布</span> :
            ...
            },
            {
                ...
                render: (text, record) => {
                    ...
                    (record.deleteStatus === false) && controls.push(
                    ...
                    (record.deleteStatus === true) && controls.push(
                ...
                <div className="system-search">
                    <ul className="search-ul more-ul">
                        ...
                        <ul className="search-func">
                            <li style={{marginTop:'2px'}}><Button icon="plus-circle-o" type="primary" onClick={() => this.onAddNewShow()}>添加代言卡</Button></li>
                        </ul>
                    </ul>
                </div>
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('addnewContent', {
                                initialValue: undefined,
                                rules: [
                                    {required: true, message: '请输入分享文案内容'},
                                ],
                            })(
                                <Input placeholder="请输入分享文案内容"  style={{width:'314px'}}/>
                            )}
                        </FormItem>
                        <FormItem
                            label="文字颜色"
