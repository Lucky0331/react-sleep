      ...
      <BrowserRouter key='browser'>
        <div key='page' className="allpage page-user">
            <div className='left'>
              <Menu
                theme="dark"
                selectedKeys={this.props.userURL ? [this.props.userURL] : ['/user/type']}
              ...
              >
                ...
                <Menu.Item key="/user/query">
                  <Link to='/user/query'><div className="d-line">用户亲友、售后、经销商、<br/>服务站查询</div></Link>
                </Menu.Item>
            ...
            <div className='right'>
              <Switch>
                  <Redirect exact from='/user' to={this.props.userURL || '/user/type'} />
