...
import { findAllProvince,findCityOrCounty,ServiceFlow,findSaleRuleByWhere,findProductTypeByWhere, findProductModelByWhere } from '../../../../a_action/shop-action';
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => {
                    const controls = [];
                    controls.push(
                        <span key="2" className="control-btn green" onClick={() => this.onQueryClick2(record)}>
                                        ...
                                        <div style={{borderBottom: 'solid 1px #CCC',marginBottom:'10px',paddingBottom:'10px'}}>
                                            <ul className="search-ul more-ul">
                                                ...
                                                <li  style={{marginLeft:'30px'}}>
                                                    <Button icon="search" type="primary" onClick={() => this.onSearch2()}>搜索</Button>
                                                </li>
                                                <li  style={{marginLeft:'10px'}}>
                                                    <Button icon="download" type="primary" onClick={() => this.onExport2()}>导出</Button>
                                                </li>
                                            </ul>
                                        </div>
                ...
                >
                    <Form>
                        ...
                        <FormItem
                            ...
                            {...formItemLayout}
                        >
                            {!!this.state.nowData2 ? this.state.nowData2.distributionType : ''}
                        </FormItem>
                        <FormItem
                            label="数量"
                            {...formItemLayout}
                        ...
                        <FormItem
                            ...
                            {...formItemLayout}
                        >
                            {!!this.state.nowData2 ? this.state.nowData2.undistributedFee : ''}
                        </FormItem>
                        <FormItem
                            label="流水号"
                            {...formItemLayout}
...
export default connect(
    ...
    (dispatch) => ({
        actions: bindActionCreators({findCityOrCounty,findSaleRuleByWhere,ServiceFlow,findAllProvince,findProductTypeByWhere,findProductModelByWhere }, dispatch),
    })
