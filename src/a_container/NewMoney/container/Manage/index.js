...
import { Form, Button, Icon, Input, Table, message, Popconfirm, Popover, Modal, Radio, Tooltip, Select, Upload,Tabs, Divider } from 'antd';
import './index.scss';
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (text, record) => {
                    ...
                    controls.push(
                        <Popconfirm key="1" title="确定删除吗?" onConfirm={() => this.onRemoveClick(record.id)} okText="确定" cancelText="取消">
                                ...
                                <Tabs type="card">
                                    <TabPane tab="收款方管理" key="1" style={{width:'1630px'}}>
                                        <div className="system-table" >
                                            <ul className="search-func"><li style={{margin:'10px'}}><Button type="primary" onClick={() => this.onAddNewShow()}><Icon type="plus-circle-o" />添加收款方</Button></li></ul>
                                            <Table
                                    ...
                                    <TabPane tab="收款方式管理" key="2">
                                        <div className="system-table" >
                                            <ul className="search-func"><li style={{margin:'10px'}}><Button type="primary" onClick={() => this.onAddNewShow()}><Icon type="plus-circle-o" />添加收款方式</Button></li></ul>
                                            <Table
