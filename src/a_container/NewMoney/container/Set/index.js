...
import { Form, Button, Icon, Input, Table, message, InputNumber, Popover, Modal, Radio, Tooltip, Select, Upload,Tabs, Divider } from 'antd';
import './index.scss';
...
import { findProductByWhere, findProductTypeByWhere, ServiceList,updateServiceList,onChange,addProduct,addMoneyList, updateProduct, updateProductType,deleteProduct,removeProduct, deleteImage, findProductModelByWhere ,upProductModel,MoneyList,updateMoneyList } from '../../../../a_action/shop-action';
...
class Category extends React.Component {
    ...
    onAddNewOk() {
        ...
        form.validateFields([
            ...
            const params = {
                ...
                me.props.actions.addMoneyList(params).then((res) => {
                    me.setState({
                        addnewLoading: false,
                    });
                    this.onGetData(this.state.pageNum, this.state.pageSize);
    ...
    onUpOk() {
        ...
        form.validateFields([
            ...
            this.props.actions.updateMoneyList(params).then((res) => {
                if (res.returnCode === "0") {
                ...
                <div className="system-search">
                    <ul className="search-func">
                        <li>
                            <div>
                                <Tabs type="card">
                                    <TabPane tab="经营收益结算规则" key="1" style={{width:'1630px'}}>
                                        <div className="system-table" >
                                            <ul className="search-func"><li style={{margin:'10px'}}><Button type="primary" onClick={() => this.onAddNewShow()}><Icon type="plus-circle-o" />添加规则</Button></li></ul>
                                            <Table
...
export default connect(
    ...
    (dispatch) => ({
        actions: bindActionCreators({ findProductByWhere,addMoneyList, findProductTypeByWhere, ServiceList,onChange,updateServiceList,addProduct,updateProductType, deleteProduct,removeProduct, deleteImage, MoneyList,findProductModelByWhere,upProductModel,updateMoneyList,updateProduct }, dispatch),
    })
