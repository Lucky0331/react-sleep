...
import { findProductTypeByWhere,onChange,onOk,refundList} from '../../../../a_action/shop-action';
...
class Category extends React.Component {
    ...
    onGetData(pageNum, pageSize) {
        const params = {
            ...
            endTime: this.state.searchTime2 ?`${tools.dateToStrQ(this.state.searchTime2._d)} 23:59:59` :'',
        };
              ...
              >
                <Form>
                    ...
                    <FormItem
                        ...
                        {...formItemLayout}
                    >
                        {!!this.state.nowData ? this.getListByModelId(this.state.nowData.activityStatus) : ''}
                    </FormItem>
                    <FormItem
                        label="用户类型"
                        {...formItemLayout}
...
export default connect(
    ...
    (dispatch) => ({
        actions: bindActionCreators({ findProductTypeByWhere,onChange,onOk,refundList}, dispatch),
    })
