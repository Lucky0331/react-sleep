...
import { getSupplierIncomeList, getSupplierIncomeMain, searchCompanyIncome ,onChange} from '../../../../a_action/curr-action';
// ==================
// Definition
// ==================
...
class Category extends React.Component {
    ...
    componentDidMount() {
        ...
        /** 进入页面获取一次总部收益详情列表 **/
        this.onGetDataHQ(this.props.test.year, this.props.test.company,this.props.test.name);
                                ...
                                <div className="system-table" >
                                    ...
                                    <ul className="search-ul more-ul" style={{marginTop:'10px',marginBottom:'10px'}}>
                                        <Tooltip placement="top" title="返回" >
                                            <a href="#/money/query"><Icon type="arrow-left" style={{color:'black',marginTop:'5px',marginLeft:'10px',fontSize:'30px'}}/></a>
                                        </Tooltip>
                                        <li style={{margin:'6px'}}>
                                            <span>结算年份：</span>
                                        ...
                                        <li style={{display:'flex',margin:'6px'}}>
                                            <span>产品公司：</span>
                                            <span>{this.getCompanyId(this.props.test.company)}</span>
                                        </li>
...
export default connect(
    ...
    (dispatch) => ({
        actions: bindActionCreators({ getSupplierIncomeList, findSaleRuleByWhere, getSupplierIncomeMain, searchCompanyIncome,findProductTypeByWhere,findAllProvince,findStationByArea,findCityOrCounty ,onChange,warning}, dispatch),
    })
