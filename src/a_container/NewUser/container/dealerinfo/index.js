...
import { Form, Button, Icon, Input, Table, message, Popconfirm, Modal, Radio, InputNumber, Select, Tooltip, Divider, Cascader ,DatePicker,Alert } from 'antd';
    ...
    makeColumns(){
        const columns = [
            ...
            },
            {
              ...
              dataIndex:'station',
              key:'station',
              render:(text,record) => {return`${record.province}${record.city}${record.region}`? `${record.province}${record.city}${record.region}` : ''}
            },
            {
                title:'创建时间',
    ...
    makeData(data) {
        ...
        return data.map((item, index) => {
            return {
                ...
                station: (item.distributorAccount) ? `${item.distributorAccount.province}${item.distributorAccount.city}${item.distributorAccount.region}` : '',
                ...
                nickName:(item.distributorAccount) ? item.distributorAccount.nickName : '',
                realName:(item.distributorAccount) ? item.distributorAccount.realName : '',
                mobile:(item.distributorAccount) ? item.distributorAccount.mobile : '',
                userName:(item.distributorAccount) ? item.distributorAccount.userName : '',
                userType:(item.distributorAccount) ? item.distributorAccount.userType : '',
      ...
      <div>
          <div className="system-search">
              <ul className="search-ul" style={{marginBottom:'10px'}}>
                  <li>
                      <span style={{marginRight:'4px',marginLeft:'13px'}}>经销商id</span>
                      <Input
                          style={{width:'172px'}}
                          suffix={suffix}
                          value={ searchEId }
                  ...
                  <li>
                      <span style={{marginRight:'4px',marginLeft:'13px'}}>经销商昵称</span>
                      <Input
                          style={{width:'172px'}}
                          suffix={suffix1}
                  ...
                  <li>
                      <span style={{marginRight:'4px',marginLeft:'13px'}}>经销商姓名</span>
                      <Input
                          style={{width:'172px'}}
                          suffix={suffix2}
                          value={ searchName }
                  ...
                  <li>
                      <span style={{marginRight:'4px',marginLeft:'13px'}}>经销商手机号</span>
                      <Input
                          suffix={suffix3}
                          value={ searchMobile }
                          style={{width:'172px'}}
                  ...
                  <li>
                      <span style={{marginRight:'4px',marginLeft:'15px'}}>经销商身份</span>
              ...
              <ul className="search-ul" style={{marginTop:'10px'}}>
                  <li>
                      <span style={{marginRight:'10px',marginLeft:'7px'}}>创建时间</span>
                      <DatePicker
          ...
          >
              <Form>
                  ...
                  <FormItem
                      ...
                      {...formItemLayout}
                  >
                      {!!this.state.nowData ? this.getCity(this.state.nowData.province2,this.state.nowData.city2,this.state.nowData.region2) : ''}
                  </FormItem>
              </Form>
          </Modal>
      </div>
